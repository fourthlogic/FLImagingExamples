...
int main()
{
	...
	do
	{
		...
		if((res = arrFliImage[EType_Source].Load(L"../../ExampleImages/OperationBitwiseXnor/Cat.flif")).IsFail())
		{
		...
		if((res = arrFliImage[EType_Operand].Load(L"../../ExampleImages/OperationBitwiseXnor/HangangRiver.flif")).IsFail())
		{
			ErrorPrint(res, "Failed to load the image file.\n");
			break;
		}

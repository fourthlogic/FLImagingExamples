...
int main()
{
	...
	do
	{
		...
		if(IsFail(eResult = blob.Filter(CBlob::EFilterItem_Area, 50, ELogicalCondition_Less)))
		{
		...
		if(IsFail(eResult = blob.Filter(CBlob::EFilterItem_Circularity, 0.7, ELogicalCondition_Less)))
		{
			ErrorPrint(eResult, "Blob filtering algorithm error occurred.");
			break;
		}

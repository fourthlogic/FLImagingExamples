...
int main()
{
	...
	do
	{
		...
		if((eResult = fliSourceImage.Load(L"../../ExampleImages/OperationLogicalNand/Cat.flif")).IsFail())
		{
		...
		{
			ErrorPrint(eResult, "Failed to execute operation logical Nand.");
			break;
		}

...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image
		if(IsFail(res = fliSourceImage.Load(L"../../ExampleImages/ReduceDimensionStdev2Dto1D/Source.flif")))
		{
		...
		CReduceDimensionStdev2Dto1D reduceDimensionStdev2Dto1D;

		// Source 이미지 설정 // Set source image 
		reduceDimensionStdev2Dto1D.SetSourceImage(fliSourceImage);

		// Destination 이미지 설정 // Set destination image
		reduceDimensionStdev2Dto1D.SetDestinationImage(fliDestinationImageX);

		// 축소 차원 설정 // Set reduction dimension
		reduceDimensionStdev2Dto1D.SetReductionDimension(CReduceDimensionStdev2Dto1D::EReductionDimension_X);
		...
		// Destination 이미지 설정 // Set destination image
		reduceDimensionStdev2Dto1D.SetDestinationImage(fliDestinationImageY);

		// 축소 차원 설정 // Set reduction dimension
		reduceDimensionStdev2Dto1D.SetReductionDimension(CReduceDimensionStdev2Dto1D::EReductionDimension_Y);

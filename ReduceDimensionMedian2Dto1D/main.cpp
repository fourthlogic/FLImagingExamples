...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image
		if(IsFail(res = fliSourceImage.Load(L"../../ExampleImages/ReduceDimensionMedian2Dto1D/Source.flif")))
		{
		...
		CReduceDimensionMedian2Dto1D reduceDimensionMedian2Dto1D;
		...
		reduceDimensionMedian2Dto1D.SetReductionDimension(CReduceDimensionMedian2Dto1D::EReductionDimension_X);
		...
		// 축소 차원 설정 // Set reduction dimension
		reduceDimensionMedian2Dto1D.SetReductionDimension(CReduceDimensionMedian2Dto1D::EReductionDimension_Y);

...
int main()
{
	...
	do
	{
		...
		FLGeometricMatchSave.SetLearnThresholdCoefficient();
		...
		if(IsFail(res = FLGeometricMatchSave.GetLearnedFeature(flfaFeaturePoints)))
		{
		...
		FLGeometricMatchLoad.SetFindThresholdCoefficient();
		...
		for(int64_t i = 0; i < i64ResultCount; ++i)
		{
			...
			FLGeometricMatchLoad.GetResultDetectedFeature(i, flfaResultPoints);

...
int main()
{
	...
	do
	{
		...
		FLGeometricMatchSave.EnablePreprocessing();

		//알고리즘 수행 // Execute the algorithm
		if(IsFail(eResult = FLGeometricMatchSave.Learn()))
		{
		...
		if(IsFail(eResult = FLGeometricMatchSave.Save(L"../../ExampleImages/Matching/Geometric Single Learn File")))
		{
		...
		if(IsFail(eResult = FLGeometricMatchSave.GetLearntFeature(flfaFeaturePoints)))
		{
		...
		if(IsFail(eResult = FLGeometricMatchLoad.Load(L"../../ExampleImages/Matching/Geometric Single Learn File")))
		{
			ErrorPrint(eResult, "Failed to load\n");
			break;
		}
		...
		FLGeometricMatchLoad.EnablePreprocessing();

		// 알고리즘 수행 // Execute the algorithm
		eResult = FLGeometricMatchLoad.Execute();

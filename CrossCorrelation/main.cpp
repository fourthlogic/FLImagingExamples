...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image
		if(IsFail(eResult = arrFliImage[EType_Source].Load(L"../../ExampleImages/CrossCorrelation/Cross Correlation Source.flif")))
		{
			ErrorPrint(eResult, "Failed to load the image file.\n");
			break;
		}

		if(IsFail(eResult = arrFliImage[EType_Operand].Load(L"../../ExampleImages/CrossCorrelation/Cross Correlation Operand.flif")))
		{
			ErrorPrint(eResult, "Failed to load the image file.\n");
			break;
		}
		...
		if((eResult = CrossCorrelation.Execute()).IsFail())
		{
			ErrorPrint(eResult, "Failed to execute Cross Correlation.");
			break;
		}

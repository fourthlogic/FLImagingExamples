...
int main()
{
	...
	do
	{
		...
		CFilterGeneratorButterworthFD filterGenerator;
		...
		filterGenerator.SetType(CFilterGeneratorButterworthFD::EFilterBaseFDType_FFT_Shift);
		...
		{
			ErrorPrint(eResult, "Failed to execute FilterGeneratorButterworthFD.");
			break;
		}

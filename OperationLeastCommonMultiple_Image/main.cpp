...
int main()
{
	...
	do
	{
		...
		if(IsFail(eResult = arrFliImage[EType_Operand].Load(L"../../ExampleImages/OperationLeastCommonMultiple/Gradient.flif")))
		{
			ErrorPrint(eResult, "Failed to load the image file.\n");
			break;
		}
		...
		lcm.SetOperandImage(arrFliImage[EType_Operand]);
		// Destination 이미지 설정 // Set the destination image
		lcm.SetDestinationImage(arrFliImage[EType_Destination]);

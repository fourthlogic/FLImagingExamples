...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image 
		if(IsFail(res = fliISrcImage.Load(L"../../ExampleImages/Threshold/Mountain.flif")))
		{
		...
		if(IsFail(res = layer.DrawTextCanvas(&CFLPoint<double>(0, 0), L"100 < threshold < 168", YELLOW, BLACK, 30, false, 0, EGUIViewImageTextAlignment_LEFT_TOP, L"", 1.f, 1.f, EGUIViewImageFontWeight_BOLD, false)))
		{

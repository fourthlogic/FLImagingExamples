...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image
		if(IsFail(res = fliSourceImage.Load(L"../../ExampleImages/ContrastEnhancement/Moon.flif")))
		{
		...
		// Contrast Enhancement 객체 생성 // Create Contrast Enhancement object
		...
		{
			ErrorPrint(res, "Failed to execute Contrast Enhancement.\n");

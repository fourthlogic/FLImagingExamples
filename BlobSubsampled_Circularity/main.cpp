...
int main()
{
	...
	do
	{
		...
		if(IsFail(eResult = blob.Filter(CBlobSubsampled::EFilterItem_Circularity, 0.85, ELogicalCondition_Less)))
		{
		...
		{
			ErrorPrint(eResult, "Failed to get circularities from the BlobSubsampled object.");
			break;
		}

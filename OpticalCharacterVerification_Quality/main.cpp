...
int main()
{
	...
	{
		// 이미지 로드 // Load image
		if((res = fliImage1.Load(L"../../ExampleImages/OpticalCharacterVerification/A.flif")).IsFail())
		{
			ErrorPrint(res, L"Failed to load the image file.\n");
			break;
		}

		if((res = fliImage2.Load(L"../../ExampleImages/OpticalCharacterVerification/A_Demaged1.flif")).IsFail())
		{
			ErrorPrint(res, L"Failed to load the image file.\n");
			break;
		}
		
		if((res = fliImage3.Load(L"../../ExampleImages/OpticalCharacterVerification/A_Demaged2.flif")).IsFail())
		{
			ErrorPrint(res, L"Failed to load the image file.\n");
			break;
		}
		...
		// OCR Font 파일을 로드
		if(IsFail(res = ocv.LoadFontData(L"../../ExampleImages/OpticalCharacterVerification/A.flocr")))
		{

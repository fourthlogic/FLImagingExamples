...
int main()
{
	...
	do
	{
		...
		if((res = fliSrcImage.Load(L"../../ExampleImages/StereoPhotometric/Source.flif")).IsFail())
		{
		...
		// StereoPhotometric 객체 생성 // Create StereoPhotometric object
		CStereoPhotometric photometric;

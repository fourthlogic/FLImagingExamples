...
int main()
{
	...
	do
	{
		...
		if((res = flrgSourceFig.Erode(i64KernelSize, i64KernelSize, &flfaResult1)).IsFail())
		{
		...
		if((res = flrgSourceFig.Erode(i64KernelSize, i64KernelSize, &flfaResult2, EKernelShape_Circle)).IsFail())
		{
			ErrorPrint(res, "Failed to calculate.\n");
			break;
		}

	...
	do
	{
		...
		if(bAutoDetect)
		{
			...
			case CDeviceGenICamTypeBase::EDeviceType_GigE:
				drReturn = camJai.GetAutoDetectGigECameraSerialNumbers(flarrSerialNumbers);
				break;

			case CDeviceGenICamTypeBase::EDeviceType_USB:
				drReturn = camJai.GetAutoDetectUSBCameraSerialNumbers(flarrSerialNumbers);
				break;
		...
		if(bAutoDetect)
		{
			...
			{
			case CDeviceGenICamTypeBase::EDeviceType_GigE:
				drReturn = camJai.AutoDetectGigECamera(i32SelectDevice);
				break;

			case CDeviceGenICamTypeBase::EDeviceType_USB:
				drReturn = camJai.AutoDetectUSBCamera(i32SelectDevice);
				break;

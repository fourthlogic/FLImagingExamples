...
int main()
{
	...
	do
	{
		...
		if(IsFail(eResult = arrFliImage[EType_Source].Load(L"../../ExampleImages/Convolution/SilverGrass.flif")))
		{
		...
		convolutionUniform.SetKernel(3);
 		...
 		if(IsFail(eResult = convolutionUniform.Execute()))
 		{
 			ErrorPrint(eResult, "Failed to execute convolution uniform.");
 			break;
 		}

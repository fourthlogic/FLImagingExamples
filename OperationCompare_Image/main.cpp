...
int main()
{
	...
	do
	{
		...
		if(IsFail(res =fliSourceImage.Load(L"../../ExampleImages/OperationCompare/siamesecat3ch.flif")))
		{
		...
		if(IsFail(res =fliOperandImage.Load(L"../../ExampleImages/OperationCompare/space3ch.flif")))
		{
			ErrorPrint(res, "Failed to load the image file.\n");
			break;
		}
		...
		if(IsFail(res =fliDestinationImage.Load(L"../../ExampleImages/OperationCompare/sea3ch.flif")))
		{
			ErrorPrint(res, "Failed to load the image file.\n");
			break;
		}

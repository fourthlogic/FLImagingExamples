...
int main()
{
	...
	do
	{
		...
		if((eResult = fliSourceImage.Load(L"../../ExampleImages/OperationBitwiseNor/circle.flif")).IsFail())
		{
		...
		if((eResult = fliOperandImage.Load(L"../../ExampleImages/OperationBitwiseNor/square.flif")).IsFail())
		{
			ErrorPrint(eResult, "Failed to load the image file.\n");
			break;
		}

...
int main()
{
	...
	{
		// 이미지 로드 // Load image
		if((res = fliImage1.Load(L"../../ExampleImages/OpticalCharacterVerification/(주)포스로직.flif")).IsFail())
		{
			ErrorPrint(res, L"Failed to load the image file.\n");
			break;
		}

		if((res = fliImage2.Load(L"../../ExampleImages/OpticalCharacterVerification/(주)포스로직2.flif")).IsFail())
		{
			ErrorPrint(res, L"Failed to load the image file.\n");
			break;
		}

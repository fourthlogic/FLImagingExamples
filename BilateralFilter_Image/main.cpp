...
int main()
{
	...
	do
	{
		...
		if((eResult = fliSourceImage.Load(L"../../ExampleImages/BilateralFilter/cat_450x480.flif")).IsFail())
		{
		...
		if((eResult = fliOperandImage.Load(L"../../ExampleImages/BilateralFilter/cat_450x480.flif")).IsFail())
		{
			ErrorPrint(eResult, "Failed to load the image file.\n");
			break;
		}
		...
		if((eResult = fliDestinationImage.Load(L"../../ExampleImages/BilateralFilter/cat_450x480.flif")).IsFail())
		{
			ErrorPrint(eResult, "Failed to load the image file.\n");
			break;
		}
		...
		if((eResult = bilateralFilter.Execute()).IsFail())
		{

...
int main()
{
	...
	do
	{
		...
		if(IsFail(res = fliLearnImage.Load(L"../../ExampleImages/OrthogonalCalibrator/Orthogonal_GridOfDots.flif")))
		{
		...
		if(IsFail(res = fliSourceImage.Load(L"../../ExampleImages/OrthogonalCalibrator/Orthogonal_GridOfDots.flif")))
		{
			ErrorPrint(res, L"Failed to load the image file.\n");
			break;
		}

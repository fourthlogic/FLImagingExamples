...
bool Calibration(COrthogonalCalibrator& sCC, CFLImage& fliLearnImage)
{
	...
	do
	{
		...
		sCC.SetGridTypeForCameraCalibration(COrthogonalCalibrator::EGridType_GridOfDots);
		...
		sCC.SetGridTypeForOrthogonalCorrection(COrthogonalCalibrator::EGridType_GridOfDots);
...
int main()
{
	...
	do
	{
		...
		if(IsFail(eResult = fliLearnImage.Load(L"../../ExampleImages/OrthogonalCalibrator/Orthogonal_GridOfDots.flif")))
		{
		...
		if(IsFail(eResult = fliSourceImage.Load(L"../../ExampleImages/OrthogonalCalibrator/Orthogonal_GridOfDots.flif")))
		{
			ErrorPrint(eResult, L"Failed to load the image file.\n");
			break;
		}

...
int main()
{
	...
	do
	{
		...
		if((res = arrFliImage[EType_Source].Load(L"../../ExampleImages/OperationBitwiseOr/Sun.flif")).IsFail())
		{
		...
		if((res = arrFliImage[EType_Operand].Load(L"../../ExampleImages/OperationBitwiseOr/Flower.flif")).IsFail())
		{
			ErrorPrint(res, "Failed to load the image file.\n");
			break;
		}

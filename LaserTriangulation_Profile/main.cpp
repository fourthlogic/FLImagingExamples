...
int main()
{
	...
	do
	{
		...
		if((eResult = fliSrcImage.Load(L"../../ExampleImages/LaserTriangulation/SrcImage.flif")).IsFail())
		{
		...
		LaserTriangulation.SetSourceType(CLaserTriangulation::ESourceType_Image);

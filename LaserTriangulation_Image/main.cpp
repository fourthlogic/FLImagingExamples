...
int main()
{
	...
	do
	{
		...
		if((res = fliSrcImage.Load(L"../../ExampleImages/LaserTriangulation/SrcProfile.flif")).IsFail())
		{
		...
		CLaserTriangulation LaserTriangulation;
		...
		LaserTriangulation.SetSourceType(CLaserTriangulation::ESourceType_Profile);

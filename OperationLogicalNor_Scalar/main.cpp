...
int main()
{
	...
	do
	{
		...
		if((eResult = fliSourceImage.Load(L"../../ExampleImages/OperationLogicalNor/circle.flif")).IsFail())
		{
		...
		{
			ErrorPrint(eResult, "Failed to execute operation logical Nor.");
			break;
		}

...
int main()
{
	...
	do
	{
		...
		if(IsFail(eResult = arrFliImage[EType_Source].Load(L"../../ExampleImages/OperationDivide/Moon.flif")))
		{
		...
		if(IsFail(eResult = arrFliImage[EType_Operand].Load(L"../../ExampleImages/OperationDivide/FlowerWall.flif")))
		{
			ErrorPrint(eResult, "Failed to load the image file.\n");
			break;
		}

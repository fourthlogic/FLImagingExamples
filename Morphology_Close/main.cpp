...
int main()
{
	...
	do
	{
		...
		if(IsFail(eResult = arrFliImage[EType_Src].Load(L"../../ExampleImages/Morphology/Chip_Noise.flif")))
		{
		...
		morphologyClose.SetKernelShape(CMorphologyClose::EKernelShape_Circle);
		morphologyClose.SetKernel(3);

...
int main()
{
	...
	do
	{
		...
		if((eResult = fliSourceImage.Load(L"../../ExampleImages/KuwaharaFilter/NoisyKodim17.flif")).IsFail())
		{
		...
		if((eResult = fliDestinationImage.Load(L"../../ExampleImages/KuwaharaFilter/NoisyKodim17.flif")).IsFail())
		{
			ErrorPrint(eResult, "Failed to load the image file.\n");
			break;
		}
		...
		{
			ErrorPrint(eResult, "Failed to execute kuwahara filter.\n");

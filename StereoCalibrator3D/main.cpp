...
bool Calibration(CStereoCalibrator3D& sSC, CFLImage& fliLearnImage, CFLImage& fliLearnImage2)
{
	bool bResult = false;
...
bool Undistortion(CStereoCalibrator3D& sSC, CFLImage& fliSourceImage, CFLImage& fliSourceImage2, CFLImage& fliDestinationImage, CFLImage& fliDestinationImage2)
{
	bool bResult = false;

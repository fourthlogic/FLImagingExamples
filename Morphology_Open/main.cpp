...
int main()
{
	...
	do
	{
		...
		if(IsFail(eResult = arrFliImage[EType_Src].Load(L"../../ExampleImages/Morphology/Chip_Noise2.flif")))
		{
		...
		morphologyOpen.SetKernelShape(CMorphologyOpen::EKernelShape_Circle);

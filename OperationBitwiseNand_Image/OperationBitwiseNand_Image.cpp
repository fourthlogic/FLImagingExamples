...
int main()
{
	...
	do
	{
		...
		if((res = fliSourceImage.Load(L"../../ExampleImages/OperationBitwiseNand/circle.flif")).IsFail())
		{
		...
		if((res = fliOperandImage.Load(L"../../ExampleImages/OperationBitwiseNand/square.flif")).IsFail())
		{
			ErrorPrint(res, "Failed to load the image file.\n");
			break;
		}
		...
		if((res = bitnand.Execute()).IsFail())
		{
			ErrorPrint(res, "Failed to execute operation bitwise nand.");
			break;
		}

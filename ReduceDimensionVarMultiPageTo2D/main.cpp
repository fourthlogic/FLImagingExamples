...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image
		if(IsFail(res = fliSourceImage.Load(L"../../ExampleImages/ReduceDimensionVarMultiPageTo2D/Source.flif")))
		{
		...
		CReduceDimensionVarMultiPageTo2D reduceDimensionVarMultiPageTo2D;

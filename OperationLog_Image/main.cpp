...
int main()
{
	...
	do
	{
		...
		if(IsFail(eResult = arrFliImage[EType_Source].Load(L"../../ExampleImages/OperationLog/gradation_Horizontal.flif")))
		{
		...
		if(IsFail(eResult = arrFliImage[EType_Operand].Load(L"../../ExampleImages/OperationLog/gradation_Vertical.flif")))
		{
			ErrorPrint(eResult, "Failed to load the image file.\n");
			break;
		}

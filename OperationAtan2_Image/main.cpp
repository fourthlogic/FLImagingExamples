...
int main()
{
	...
	do
	{
		...
		// 이미지 로드 // Loads image
		if(IsFail(res = arrFliImage[EType_Source].Load(L"../../ExampleImages/OperationAtan2/Sky.flif")))
		{
			ErrorPrint(res, "Failed to load the image file.\n");
			break;
		}

		if(IsFail(res = arrFliImage[EType_Operand].Load(L"../../ExampleImages/OperationAtan2/Flower.flif")))
		{
			ErrorPrint(res, "Failed to load the image file.\n");
			break;
		}

...
int main()
{
	...
	do
	{
		...
		if(IsFail(eResult = arrFliImage[EType_Operand].Load(L"../../ExampleImages/OperationMultiply/Flower.flif")))
		{
			ErrorPrint(eResult, "Failed to load the image file.\n");
			break;
		}
		...
		multiply.SetOperandImage(arrFliImage[EType_Operand]);
		// Destination 이미지 설정 // Set the destination image
		multiply.SetDestinationImage(arrFliImage[EType_Destination]);

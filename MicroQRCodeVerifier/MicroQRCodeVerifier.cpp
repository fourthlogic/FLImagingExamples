...
int main()
{
	...
	do
	{
		...
		// MicroQR Code Verifier 객체 생성 // Create MicroQR Code Verifier object
		...
		// MicroQR Code Verifier 결과 개수를 얻는다.
		int64_t i64Results = qrCodeVerifier.GetResultCount();

		for(int64_t i = 0; i < i64Results; ++i)
		{

			// MicroQR Code Verifier 결과를 얻어오기 위해 FLQuadD 선언
			CFLQuad<double> flqdRegion;

			// MicroQR Code Verifier 결과들 중 Data Region 을 얻어옴
			...
			// MicroQR Code Verifier 결과를 얻어오기 위해 FigureArray 선언
			CFLFigureArray flfaGridRegion;

			// MicroQR Code Verifier 결과들 중 Grid Region 을 얻어옴
			...
			// MicroQR Code Verifier 결과를 얻어오기 위해 FLFigureArray 선언
			CFLFigureArray flfaFinderPattern;

			// MicroQR Code Verifier 결과들 중 Finder Pattern 을 얻어옴
			...
			// MicroQR Code Verifier 결과를 얻어오기 위해 FLStringW 선언
			CFLString<wchar_t> flstrDecoded;

			// MicroQR Code Verifier 결과들 중 Decoded String 을 얻어옴
			...
			// Micro QR Code Verifier 결과들 중 인쇄 품질을 얻어옴 // Get print quality among Micro QR Code Verifier results

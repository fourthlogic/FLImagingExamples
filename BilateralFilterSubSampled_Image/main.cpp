...
int main()
{
	...
	do
	{
		...
		if((res = fliSourceImage.Load(L"../../ExampleImages/BilateralFilterSubSampled/cat_450x480.flif")).IsFail())
		{
		...
		if((res = fliOperandImage.Load(L"../../ExampleImages/BilateralFilterSubSampled/cat_450x480.flif")).IsFail())
		{
			ErrorPrint(res, "Failed to load the image file.\n");
			break;
		}
		...
		if((res = fliDestinationImage.Load(L"../../ExampleImages/BilateralFilterSubSampled/cat_450x480.flif")).IsFail())
		{
			ErrorPrint(res, "Failed to load the image file.\n");
			break;
		}

...
int main()
{
	...
	do
	{
		...
		if((res = fliSrcImage.Load(L"../../ExampleImages/InpaintingCoherenceTransport/owl.flif")).IsFail())
		{
		...
		if((res = flrInpaintingRegion.Load(L"../../ExampleImages/InpaintingCoherenceTransport/InpaintingRegionOwl.fig")).IsFail())
		{

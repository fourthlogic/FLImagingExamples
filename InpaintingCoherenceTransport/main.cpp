...
int main()
{
	...
	do
	{
		...
		if((eResult = fliSrcImage.Load(L"../../ExampleImages/InpaintingCoherenceTransport/owl.flif")).IsFail())
		{
		...
		if((eResult = flrInpaintingRegion.Load(L"../../ExampleImages/InpaintingCoherenceTransport/InpaintingRegionOwl.fig")).IsFail())
		{
		...
		{
			ErrorPrint(eResult, L"Failed to execute InpaintingCoherenceTransport.");
			break;
		}

...
int main()
{
	...
	do
	{
		...
		if(IsFail(eResult = flcSource1.GetPointsOfMaximumDistance(flqOperand1, &flpaResult1)))
		{
		...
		if(IsFail(eResult = flfaSource2.GetPointsOfMaximumDistance(flfaOperand2, &flpaResult2)))
		{
			ErrorPrint(eResult, "Failed to process.\n");
			break;
		}
		...
		if(IsFail(eResult = flcSource1.GetMaximumDistance(flqOperand1, &f64MaximumDistance1)))
		{
			ErrorPrint(eResult, "Failed to process.\n");
			break;
		}
		...
		if(IsFail(eResult = flfaSource2.GetMaximumDistance(flfaOperand2, &f64MaximumDistance2)))
		{
			ErrorPrint(eResult, "Failed to process.\n");
			break;
		}
